    ...
    <main className="legal">
      ...
      <ul>
        <li>
          ...
          <em>{glossary.tabs.you}</em> → <em>{glossary.you.deleteAccount}</em>. This
          permanently removes your profile, your hoard, and the benches you&rsquo;ve
          added. You can also email us to request deletion.
        </li>
        <li>
          <strong>Is {glossary.brand.name} free?</strong> Yes — the map, the
          compass, and every bench&rsquo;s qualities are free and need no account.
